...
<circle cx="179.166" cy="130.218" r="107.289" stroke="url(#paint0_linear_785_276)" stroke-width="10" strokeLinecap="round"/>
...
<div className="bluredafter2"></div>
            <div className="bluredbefore2"></div>
  {/* topsvg */}
    
<svg className="statsvg" height="720" viewBox="0 0 375 678" fill="none" xmlns="http://www.w3.org/2000/svg">
